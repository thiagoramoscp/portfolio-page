...
<body>
            ...
            <div class="odd-column">
                <div class="project1">
                    <a href="https://codepen.io/thiagoramoscp/pen/zYGqWyZ" id="profile-link" target="_blank">
                        <img src="https://lh3.googleusercontent.com/pYUe0-CWaBItLG25qWppfTrO9ix72y8UHpEZ-oFcEru94xu9_cfEGDnK5QkkZ1Fjz2EgBQc6_U6pthSiwEjYqZEP_692JAXJ4ZfP3U50VrTnnsmht6go_vEafKmlmGr0uBOPDEAnag=w2400" alt=""></img>
                        <div class="middle">
                ...
                <div class="project3">
                    <a href="https://codepen.io/thiagoramoscp/pen/oNXXoBa" target="_blank">
                        <img src="https://lh3.googleusercontent.com/FhbZbx6NF_Jzpwif4GeU6rs5C1S1WAgven7PfSAcN9VQ9MAm4hu0xzPfUTEb6u90zRhvJ3sZe_sBsEro4d0fV3ZzHGvlXvlVo8P8Kyh3p3MFCGFONuM7_PyFvBMVJLgwBDKCF-Fmrw=w2400" alt=""></img>
                        <div class="middle">
            ...
            <div class="even-column">
                <div class="project2">
                    <a href="https://codepen.io/thiagoramoscp/pen/mdJMVdN" target="_blank">
                        <img src="https://lh3.googleusercontent.com/RDazKUFXtDiyv7FRCmYLu2DsJIe5fBZc-p7RwmIDSwaAg4SkWg5u9q39nUVVm4XPoM9AzbOLqaFZuvy7rcn4K0B5NTBXU9CTVZ5IdbK92_GLLh4nGStnvclbDeSQ5JMQPMVkbcaDcA=w2400" alt=""></img>
                        <div class="middle">
    ...
    <section class="contact-section" id="contact">
        <h2>Contato</h2>
        <form class="contact-form" id="contect-form" action="">
